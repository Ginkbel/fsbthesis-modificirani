...
% \usepackage[croatian]{babel} % ako se piše rad na hrvatskom jeziku
\usepackage{xspace}
\usepackage{url}
\def\UrlBreaks{\do\/\do-} % Allow line breaks at slashes and hyphens

\usepackage{hangcaption}
\usepackage[english,croatian,refpage]{nomencl}
\usepackage{float}
\makenomenclature
...
\setlength{\headsep}{5pt} % udaljenost početka teksta od donjeg dijela header-a
...
%\date{Zagreb, July 2024}      % -- promijeniti datum: mjesec i godina - EN (za master opciju)
\date{Zagreb, srpanj 2024.}      % -- promijeniti datum: mjesec i godina - HR
...
\renewcommand{\FSBgodina}{2024.} %-- promijeniti godinu obrane rada
\renewcommand{\FSBkljucnerijeci}{popis ključnih riječi: maksimalno do deset \ldots} %-- promijeniti popis kljucnih rijeci
...
%\renewcommand{\FSBbibdatumobr}{1. travnja 2024.}
% \renewcommand{\FSBbibznpolje}{zrakoplovstvo, raketna i svemirska tehnika}
% \renewcommand{\FSBbibdatumobr}{1. travnja 2024.}
...
\input Poglavlja/zakljuc.tex
\addtocounter{brojslika}{\arabic{figure}}
\addtocounter{brojtablica}{\arabic{table}}

\appendix
\input Poglavlja/prilog.tex
\addtocounter{brojslika}{\arabic{figure}}
\addtocounter{brojtablica}{\arabic{table}}
